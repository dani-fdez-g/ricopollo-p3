...
<html>
<head>
    <title>POLITICAS - RICOPOLLO</title>
</head> 
...
<h4 class="subtitulo">
Enlaces a otros sitios web:</h4><p class="texto">
...
<h4 class="subtitulo">Seguridad de la información:</h4><p class="texto">
...
<h4 class="subtitulo">Divulgación legal:</h4><p class="texto">
...
<h4 class="subtitulo">Información de contacto:</h4><p class="texto">
Si deseas comunicarte con nosotros para comprender más sobre esta Política o deseas comunicarte con nosotros en relación con cualquier asunto sobre los derechos individuales y tu información personal, puedes enviarnos un correo electrónico a ricopollo@contact.com.
</p>
</section>
